---
name: vsp-marp-theme
description: VSP-Marp 主题子技能。用于选择、解释、套用或调整 report-red/report-nailong/tutorial-red/tutorial-red-shtu/tutorial-purple/tutorial-nailong 主题和模板。触发条件：用户问主题、模板、样式、配色、版式、theme。
---
